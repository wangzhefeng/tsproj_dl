...
def args_parse():
    ...
    parser.add_argument('--train_step', type=int, default=1, help="Train data window step")
    parser.add_argument('--valid_step', type=int, default=1, help="Valid data window step")
    parser.add_argument('--testing_step', type=int, default=1, help="Test data window step")
    ...
    # TODO RNNs
    parser.add_argument("--pred_method", type=str, default="recursive_multi_step", help="Prediction method: recursive_multi_step | direct_multi_step | direct_recursive_multi_step_mix | direct_multi_output | seq2seq_multi_step")
