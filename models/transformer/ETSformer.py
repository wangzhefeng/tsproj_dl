...
# * Date        : 2026-03-28
# * Version     : 1.0.032820
# * Description : Time-Series-Library ETSformer model adapted for local config style
# ***************************************************
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.ets_layers = min(configs.e_layers, configs.d_layers)
        ...
        self.encoder = Encoder(
            [
                ...
                ) for _ in range(self.ets_layers)
            ]
        )
        # Decoder
